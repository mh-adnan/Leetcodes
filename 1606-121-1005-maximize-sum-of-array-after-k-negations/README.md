<h2> 1606 121
1005. Maximize Sum Of Array After K Negations</h2><hr><div><p>Given an integer array <code>nums</code> and an integer <code>k</code>, modify the array in the following way:</p>
